...
_SEGMENTATION: dict[str, dict[str, str]] = {
    "almeida_2023": {"file_id": "1BlHvG0MkWwuqGA3ImUJ09D9E7rsVt5ER", "data_authors": "Almeida et al. 2023", "size_gb": "0.927", "license": "CC BY 4.0"},
    "arvidsson_2022": {"file_id": "12Cwk5MX3V9z_2KmBJyn5jXc-JuW7-e2k", "data_authors": "Arvidsson et al. 2022", "size_gb": "0.028", "license": "CC BY 4.0"},
    "cellpose_2021": {"file_id": "12Z9PpJEdSE0bHALNxpAAeD6WA9aBhMEO", "data_authors": "Stringer et al. 2021", "size_gb": "0.356", "license": "Custom NC"},
    "conic_2022": {"file_id": "1nXOnDkWpRfU5iGXFZe06-CQaAMFq13f_", "data_authors": "Graham et al. 2022", "size_gb": "1.920", "license": "CC BY-NC 4.0"},
    "cryonuseg_2021": {"file_id": "1cfIY9BSlTe0RNaq1V8fZmKJwWyBs4WEj", "data_authors": "Mahbod et al. 2021", "size_gb": "0.031", "license": "MIT"},
    "dsb_2019": {"file_id": "1qgAyMcrZwLudlA4vjy7jwuKTjAxT7Ky2", "data_authors": "Caicedo et al. 2019", "size_gb": "0.112", "license": "CC0 1.0 Universal"},
    "hpa_2022": {"file_id": "1NyV6xuIAIuaSiXp0H-4VCV8tjaNSpXtX", "data_authors": "HPA 2022", "size_gb": "1.630", "license": "CC BY 4.0"},
    "livecell_2021": {"file_id": "1JNXkZS0QSQW25b-opoyKomPKCfO_3pkx", "data_authors": "Edlund et al. 2021", "size_gb": "3.260", "license": "CC BY-NC 4.0"},
    "nuinseg_2024": {"file_id": "1gSmbsfhO7aP1yBB5R9XMMrAH4hy-Thmm", "data_authors": "Mahbod et al. 2024", "size_gb": "0.347", "license": "MIT"},
    "pannuke_2020": {"file_id": "1J9CeH9t23EpottNyUKeBBkYpTfMR3EgT", "data_authors": "Gamper et al. 2020", "size_gb": "1.250", "license": "CC BY-NC-SA 4.0"},
    "tissuenet_2022": {"file_id": "1ilHrzUuGfobSdFmTezyynCWCLIoJwaHQ", "data_authors": "Greenwald et al. 2022", "size_gb": "4.270", "license": "Modified NC Apache"},
    "vicar_2021": {"file_id": "12tJOlIHZPFqp8GLek_jV__Uhhgsa530_", "data_authors": "Vicar et al. 2021", "size_gb": "0.113", "license": "CC BY 4.0"},
}

_BENCHMARK: dict[str, dict[str, str]] = {
    "amgad_2022": {"file_id": "1JHlGon82bYPhpeOwbRYxz4uRxhcxasr3", "data_authors": "Amgad et al. 2022", "size_gb": "0.062", "license": "CC0 1.0"},
    "cnmc_2019": {"file_id": "1a7Wt0kwt3Uq1NKMtBsWmesMH4tCwqkgi", "data_authors": "C-NMC Challenge", "size_gb": "0.182", "license": "CC BY 3.0"},
    "fracatlas_2023": {"file_id": "1vyXNA4bxMFk-7Hw59TPiWIfX-BzTSmCd", "data_authors": "Abedeen et al. 2023", "size_gb": "0.247", "license": "CC BY 4.0"},
    "isic_2019": {"file_id": "1CDGbcBxs7SUemGwpBtoVYJblqCNgw469", "data_authors": "ISIC", "size_gb": "1.140", "license": "CC BY-NC 4.0"},
    "kermany_2018": {"file_id": "1Xk7LWa7HWzTN7Nxsa8MuefBmzNsz4VuM", "data_authors": "Kermany et al. 2018", "size_gb": "0.638", "license": "CC BY 4.0"},
    "kromp_2023": {"file_id": "16RXNWQXlw_scJ75DwowngxJHYB2rZsW7", "data_authors": "Kromp et al. 2023", "size_gb": "0.025", "license": "CC BY 4.0"},
    "matek_2021": {"file_id": "1BDYtZoqSUUZQmWgcEBtopaJTWgwrAXGz", "data_authors": "Matek et al. 2021", "size_gb": "0.508", "license": "CC BY 4.0"},
    "murphy_2001": {"file_id": "1fl4dwbjX11SpDRhwbIi2-lbcswvyr1F_", "data_authors": "Murphy et al. 2001", "size_gb": "0.033", "license": "MIT"},
    "opencell_2024": {"file_id": "1nlqt7ujUPciEoAKriIu_bqE5fUJZX4nx", "data_authors": "OpenCell", "size_gb": "1.030", "license": "MIT"},
    "phillip_2021": {"file_id": "1yE4BblXBAPJDT1AnK3gghHAS3cZUFCd6", "data_authors": "Phillip et al. 2021", "size_gb": "0.032", "license": "MIT"},
    "recursion_2019": {"file_id": "1209hlaKcOqKdEGOwvlRhJakX8ciN-SX8", "data_authors": "Recursion", "size_gb": "0.037", "license": "CC BY-NC-SA 4.0"},
    "verma_2021": {"file_id": "1AyU-4-doJY2GX3dmf7ryPDCvDA_x4PPD", "data_authors": "Verma et al. 2021", "size_gb": "0.021", "license": "CC BY-NC-SA 4.0"},
    "runtime": {"file_id": "1BlXIv49oxj2dsiiEASbTEiyh7QpIjYb_", "data_authors": "MIT", "size_gb": "0.017", "license": "MIT"},
}

_WEIGHTS: dict[str, dict[str, str]] = {
    "dino_vit_small": {"file_id": "1xuyTyPsuPiDtec8ojZwAyXSDq9AzyPQX", "filename": "dinov2_vits14_imagenet.safetensors", "data_authors": "Huggingface/candle", "size_gb": "0.097", "license": "Apache License 2.0"},
    "dino_vit_base": {"file_id": "19vy-A-KTaaF3vsWKxu0JpA0gaATU52Gh", "filename": "dinov2_vitb14_imagenet.safetensors", "data_authors": "Huggingface/candle", "size_gb": "0.330", "license": "Apache License 2.0"},
    "dinobloom_vit_base": {"file_id": "1XhzSiO2IDKppr2UCTAio_niLSk5QA6hG", "filename": "dinov2_vitb14_dinobloom.safetensors", "data_authors": "Marr Lab", "size_gb": "0.330", "license": "Apache License 2.0"},
    "scdino_vit_small": {"file_id": "1omwQNJVMkrbYCstSF11p5HsErHzINTz6", "filename": "scdino_vit_small.safetensors", "data_authors": "Snijder Lab", "size_gb": "0.097", "license": "Apache License 2.0"},
    "subcell_vit_base": {"file_id": "1LZn3xlgVVd2jQIpXst4CMCYN58F-VG-x", "filename": "subcell_vit_base.safetensors", "data_authors": "Lundberg Lab", "size_gb": "0.330", "license": "MIT License"},
}
